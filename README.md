...
🧬 三层进化引擎 — Darwin + EvoPrompt + SEW | 让所有项目自进化 | 适配任意AI项目
...
1. **克隆仓库**
```bash
git clone https://github.com/MoKangMedical/evox.git
cd evox
```
...
2. **运行容器**
```bash
docker run -d -p 8000:8000 --name evox evox
```
...
- **项目主页**: https://github.com/MoKangMedical/evox
- **问题反馈**: https://github.com/MoKangMedical/evox/issues
